<template>
  <div
    class="min-h-screen flex items-center justify-center bg-blue-600 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
  >
    ...
    <div class="max-w-md w-full space-y-8 relative z-10">
      ...
      <!-- Login Form -->
      <form
        class="mt-8 space-y-6 bg-white bg-opacity-90 backdrop-blur-lg rounded-xl p-8 shadow-2xl"
      ...
      <div class="mt-8 space-y-4">
        <div
          class="bg-white bg-opacity-90 backdrop-blur-lg border border-blue-200 rounded-lg p-4 shadow-xl"
        >
        ...
        <div
          class="bg-white bg-opacity-90 backdrop-blur-lg border border-gray-200 rounded-lg p-4 shadow-xl hidden"
        >
          ...
          <div class="space-y-1 text-xs text-gray-600">
            ...
            <p><strong>Worker:</strong> ebere@attendance.com / worker123</p>
...
const quickLoginWorker = () => {
  form.email = "okoriechigozie99@gmail.com";
