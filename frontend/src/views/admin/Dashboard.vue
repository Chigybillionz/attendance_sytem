...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7 bg-blue-600">
      ...
      <div class="bg-blue-300 rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div v-if="weeklyChart && weeklyChart.length" class="space-y-3">
          ...
          >
            <div class="flex items-center space-x-3">
              <div class="w-16 text-sm font-medium text-black">{{ day.day }}</div>
              ...
              <div class="w-32 bg-gray-200 rounded-full h-2">
                <div
                  ...
                  :style="`width: ${Math.min(
                    (day.attendance / overview.total_employees) * 100,
                    100
                  )}%`"
                ></div>
              </div>
    ...
    >
      <div
        class="bg-white rounded-lg w-full max-w-7xl my-8 max-h-[calc(100vh-4rem)] overflow-hidden"
      >
        <div class="p-6 border-b border-gray-200">
          <div class="flex justify-between items-center">
            <h3 class="text-xl font-semibold text-gray-900">User Management System</h3>
            <button @click="showUserManagement = false" class="text-gray-500 hover:text-gray-700">
